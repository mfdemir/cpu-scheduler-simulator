...
namespace CPU_Scheduler_Simulator
{
    class FirstComeFirstServeScheduler : MultiLevelableScheduler
    {
        ...
        public FirstComeFirstServeScheduler(string _name, List<Process> _processes, Color _graphColor)
        {
            name = _name;
        ...
        public FirstComeFirstServeScheduler(string _name, List<Process> _processes, Color _graphColor,int _number)
        {
            name = _name;
            List<Process> copyProcesses = new List<Process>();
            allProcesses = new List<Process>(copyProcesses);
