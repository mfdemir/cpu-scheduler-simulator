...
namespace CPU_Scheduler_Simulator
{
    ...
    public class RoundRobinScheduler : MultiLevelableScheduler
    {
        ...
        public RoundRobinScheduler(string _name, int _quantum, List<Process> _processes, Color _graphColor)
        {
            name = _name;
            quantum = _quantum;
            List<Process> copyProcesses = new List<Process>();
        ...
        public RoundRobinScheduler(string _name, int _quantum, List<Process> _processes, Color _graphColor, int _number)
        {
            name = _name;
            quantum = _quantum;
            List<Process> copyProcesses = new List<Process>();
